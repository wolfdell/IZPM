...
class Translation:
    ...
    def create_folder_name(self):
        folder_name = '_'.join(self.manga_name.lower().split())
        return folder_name

    # Метод за създаване на файлов път за превода
    def create_path(self):
        return 'translations/' + self.create_folder_name() + '/'

    def create_files(self):
        os.mkdir(self.create_path())
